<section class="text-gray-600 body-font">
	<div class="container px-5 py-24 mx-auto mt-12">
		<div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
			<h1
				class="sm:text-3xl text-2xl font-large
		 title-font font-extrabold mb-2 text-blue-600 dark:text-neutral-100"
			>
				Looking for Medical Care?
			</h1>
			<p class="lg:w-1/2 w-full leading-relaxed text-gray-500 dark:text-neutral-100">
				We help you expand your practice and reach to a whole new levels with telemedicine by just
		...
		<div class="flex flex-wrap -mt-7">
			<div class="xl:w-1/3 md:w-1/2 p-4">
				<div class="border border-gray-200 p-6 rounded-lg">
					...
					<h2 class="text-lg text-gray-900 font-medium title-font mb-2 dark:text-neutral-100">
						Video Confrence Checkup
					</h2>
					<p class="leading-relaxed text-base dark:text-indigo-100">
			...
			<div class="xl:w-1/3 md:w-1/2 p-4">
				<div class="border border-gray-200 p-6 rounded-lg">
					...
					<p class="leading-relaxed text-base dark:text-neutral-100">
						Fingerstache flexitarian street art 8-bit waist co, subway tile poke farm.
					</p>
				</div>
			</div>
